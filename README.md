...
https://github.com/user-attachments/assets/34f7ce70-b28c-457a-b9ba-cac2b345f4f1
Download the compressed package corresponding to your platform, and run the PdfMerger executable file after decompression.
Main Interface:
...
Click ​​"Start Merging"​​, and the progress bar will display in real time.
After the merging is completed, you can open the folder where the output file is located.
